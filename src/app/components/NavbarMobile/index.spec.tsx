...
describe('<NavbarMobile/>', () => {
  ...
  //   const aboutLink = getByRole('link', { name: /on/i })
  //   const vacanciesLink = getByRole('link', { name: /Vacancies/i })
  ...
  it('should have the correct text for each navigation link', () => {
    ...
    expect(getByRole('link', { name: /on/i })).toBeInTheDocument()
    expect(getByRole('link', { name: /Vacancies/i })).toBeInTheDocument()
  ...
  //   fireEvent.click(getByRole('link', { name: /on/i }))
  //   fireEvent.click(getByRole('link', { name: /Vacancies/i }))
  //   fireEvent.click(getByRole('link', { name: /blog/i }))
  //   fireEvent.click(getByRole('link', { name: /Projects/i }))
