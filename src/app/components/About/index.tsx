      ...
      <div className="flex flex-col gap-10 xl:flex-row xl:items-center xl:justify-between">
        <article className="w-full xl:w-[45.5rem]">
          ...
          <p className="mt-6 leading-8 text-zinc-50">
            ...
            and dedicated to web development, covering both Front-end and
            Back-end. With the aim of{" "}
            <span className="text-primary-400">make a difference</span> , we
            combine our{" "}
            <span className="text-primary-400">knowledge and skills</span> para
            promover o{" "}
            <span className="text-primary-400">
          ...
          <div className="mt-4 hidden grid-cols-2 gap-4 sm:grid">
            <article className="rounded border border-primary-400 p-4 pl-0 text-zinc-50 transition-all duration-500 ease-out sm:border-none">
              ...
              <p className="mt-5 leading-8 transition-all duration-500 ease-out">
                ...
                <span className="text-primary-400">
                  overcome challenges and boost potential{" "}
                </span>{" "}
                of each individual, promoting personal and collective
                development.
              </p>
            </article>
            <article className="rounded border border-primary-400 pt-4 text-zinc-50 transition-all duration-500 ease-out sm:border-none">
              ...
              <p className="mt-5 leading-8 transition-all duration-500 ease-out">
                We are a group{" "}
                <span className="text-primary-400">non-profit volunteer</span>,
                seeking projects that have an impact on society, valuing
                innovative and inclusive solutions. Bringing together people who
                are passionate about web development, we encourage the exchange
                of knowledge and teamwork for a{" "}
                <span className="text-primary-400">
          ...
          <article className="mt-10 hidden rounded border border-primary-400 text-zinc-50 transition-all duration-500 ease-out sm:block sm:border-none">
            ...
            <p className="mt-5 leading-8 transition-all duration-500 ease-out">
              ...
              community. We value{" "}
              <span className="text-primary-400">
                innovation, accessibility and inclusion{" "}
              </span>
              ,keeping a{" "}
              <span className="text-primary-400">
                welcoming, respectful and collaborative environment{" "}
              </span>{" "}
              for all members.
            </p>
          </article>
